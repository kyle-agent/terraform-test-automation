...
data "samsungcloudplatformv2_sqlserver_cluster" "smoke" {
}

data "samsungcloudplatformv2_sqlserver_clusters" "smoke" {
}

data "samsungcloudplatformv2_sqlserver_engine_version" "smoke" {
}
