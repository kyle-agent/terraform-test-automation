...
data "samsungcloudplatformv2_network_logging_network_logging_configurations" "smoke" {
  resource_type = "SECURITY_GROUP"
}

data "samsungcloudplatformv2_network_logging_network_logging_storages" "smoke" {
  resource_type = "SECURITY_GROUP"
}
