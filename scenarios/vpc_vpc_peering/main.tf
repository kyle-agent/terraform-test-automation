...
resource "samsungcloudplatformv2_vpc_vpc_peering" "regr" {
  approver_vpc_account_id = "00000000-0000-0000-0000-000000000000"
  approver_vpc_id = "00000000-0000-0000-0000-000000000000"
  name = "regr"
  requester_vpc_id = "00000000-0000-0000-0000-000000000000"
}
