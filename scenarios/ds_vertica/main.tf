...
data "samsungcloudplatformv2_vertica_cluster" "smoke" {
}

data "samsungcloudplatformv2_vertica_clusters" "smoke" {
}

data "samsungcloudplatformv2_vertica_engine_version" "smoke" {
}
