...
data "samsungcloudplatformv2_searchengine_cluster" "smoke" {
}

data "samsungcloudplatformv2_searchengine_clusters" "smoke" {
}

data "samsungcloudplatformv2_searchengine_engine_version" "smoke" {
}
