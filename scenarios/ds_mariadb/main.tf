...
data "samsungcloudplatformv2_mariadb_cluster" "smoke" {
}

data "samsungcloudplatformv2_mariadb_clusters" "smoke" {
}

data "samsungcloudplatformv2_mariadb_engine_version" "smoke" {
}
