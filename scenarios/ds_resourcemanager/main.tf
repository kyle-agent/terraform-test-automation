...
data "samsungcloudplatformv2_resourcemanager_resource_group" "smoke" {
}

data "samsungcloudplatformv2_resourcemanager_resource_groups" "smoke" {
}

data "samsungcloudplatformv2_resourcemanager_tags" "smoke" {
}
