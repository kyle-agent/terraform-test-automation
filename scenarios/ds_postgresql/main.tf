...
data "samsungcloudplatformv2_postgresql_cluster" "smoke" {
}

data "samsungcloudplatformv2_postgresql_clusters" "smoke" {
}

data "samsungcloudplatformv2_postgresql_engine_version" "smoke" {
}
