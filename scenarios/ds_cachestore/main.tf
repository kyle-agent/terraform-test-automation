...
data "samsungcloudplatformv2_cachestore_cluster" "smoke" {
}

data "samsungcloudplatformv2_cachestore_clusters" "smoke" {
}

data "samsungcloudplatformv2_cachestore_engine_version" "smoke" {
}
