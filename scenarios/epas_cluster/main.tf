...
# Guards the samsungcloudplatformv2_epas_cluster fixture: a single-node EDB
# Postgres Advanced Server DBaaS cluster exercising the encoding / locale init
# options plus instance_groups nesting in the schema validate sweep.
