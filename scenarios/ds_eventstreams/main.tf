...
data "samsungcloudplatformv2_eventstreams_cluster" "smoke" {
}

data "samsungcloudplatformv2_eventstreams_clusters" "smoke" {
}

data "samsungcloudplatformv2_eventstreams_engine_version" "smoke" {
}
