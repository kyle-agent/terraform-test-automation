...
| with a capability-matrix scenario run | 77 | 99% |
| reaching **validate** (green) | 77 | 99% |
| reaching **plan** (green) | 77 | 99% |
| reaching **apply** (green) | 70 | 90% |
| reaching **replan** (green) | 70 | 90% |
| reaching **destroy** (green) | 70 | 90% |
| **lifecycle green** (validate→plan→apply→replan→destroy ok) | 70 | 89.7% |
| in-place **update** verified (separate axis) | 38 | 49% |
| **import** verified (separate axis, ImportState #81) | 27 | 35% |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `cachestore_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_cachestore_cluster.regr: Error: Value … |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `epas_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_epas_cluster.regr: Error: Value Conver… |

### eventstreams (1/1 lifecycle green)

| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `eventstreams_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_eventstreams_cluster.regression: Error… |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `mariadb_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_mariadb_cluster.regr: Error: Value Con… |

### mysql (1/1 lifecycle green)

| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `mysql_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_mysql_cluster.regr: Error: Value Conve… |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `postgresql_cluster` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_postgresql_cluster.regr: Error: Value … |
...
| `vpc_vpc_peering` | ok | ok | ok | ok | ok | destroy |  |
