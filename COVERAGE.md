...
| reaching **apply** (green) | 58 | 73% |
| reaching **replan** (green) | 53 | 67% |
| reaching **destroy** (green) | 57 | 72% |
| **lifecycle green** (validate→plan→apply→replan→destroy ok) | 52 | 65.8% |
| in-place **update** verified (separate axis) | 0 | 0% |
...
### postgresql (0/1 lifecycle green)
