...
| reaching **plan** (green) | 75 | 96% |
| reaching **apply** (green) | 62 | 79% |
| reaching **replan** (green) | 62 | 79% |
| reaching **destroy** (green) | 61 | 78% |
| **lifecycle green** (validate→plan→apply→replan→destroy ok) | 61 | 78.2% |
...
### cachestore (0/1 lifecycle green)

| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `cachestore_cluster` | ok | ok | fail | skip | skip | plan | Error: Error creating cluster with samsungcloudplatformv2_cachestore_cluster.re… |
