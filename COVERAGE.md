...
| excluded from testable surface (non-defect) | 8 | - |
| **testable surface** | 79 | 100% |
| with a capability-matrix scenario run | 76 | 96% |
| reaching **validate** (green) | 76 | 96% |
| reaching **plan** (green) | 75 | 95% |
| reaching **apply** (green) | 57 | 72% |
| reaching **replan** (green) | 57 | 72% |
| reaching **destroy** (green) | 54 | 68% |
| **lifecycle green** (validate→plan→apply→replan→destroy ok) | 54 | 68.4% |
...
### dns (1/4 lifecycle green)

| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `dns_hosted_zone` | ok | ok | ok | ok | fail | replan | import unsupported (no ImportState; see #4): samsungcloudplatformv2_dns_hosted_… |
...
| `dns_record` | ok | ok | ok | ok | fail | replan | import unsupported (no ImportState; see #4): samsungcloudplatformv2_dns_hosted_… |
...
| `iam_user` | ok | ok | fail | skip | skip | plan | Error: Error creating user with samsungcloudplatformv2_iam_user.regr, on main.t… |
