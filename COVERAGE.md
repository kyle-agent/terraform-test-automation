...
| **import** verified (separate axis, ImportState #81) | 23 | 29% |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `firewall_firewall_rule` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_firewall_firewall_rule.regr: Error: Va… |
