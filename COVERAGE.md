...
| reaching **apply** (green) | 69 | 88% |
| reaching **replan** (green) | 69 | 88% |
| reaching **destroy** (green) | 69 | 88% |
| **lifecycle green** (validate→plan→apply→replan→destroy ok) | 69 | 88.5% |
...
| `iam_user` | ok | ok | ok | ok | ok | destroy | update apply failed: Error: Error updating User with samsungcloudplatformv2_iam… |
...
| `vpc_transit_gateway_firewall` | ok | ok | ok | ok | ok | destroy | import unsupported (no ImportState; see #4): samsungcloudplatformv2_vpc_transit… |
...
| `vpc_transit_gateway_uplink_rule` | ok | ok | ok | ok | ok | destroy | import unsupported (no ImportState; see #4): samsungcloudplatformv2_vpc_transit… |
