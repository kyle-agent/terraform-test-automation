...
| **import** verified (separate axis, ImportState #81) | 21 | 27% |
...
| resource | validate | plan | apply | replan | destroy | highest | note |
|---|---|---|---|---|---|---|---|
| `dns_hosted_zone` | ok | ok | ok | ok | ok | destroy | import failed for samsungcloudplatformv2_dns_hosted_zone.regr: Error: Value Con… |
...
| `vpc_private_nat` | ok | ok | ok | ok | ok | destroy |  |
